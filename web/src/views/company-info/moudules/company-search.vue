  ...
  <NCard :title="$t('common.search')" :bordered="false" size="small" class="card-wrapper">
    <NForm ref="formRef" :model="model" label-placement="left" :label-width="100">
      <NGrid responsive="screen" item-responsive>
        <NFormItemGi span="24 s:8 m:6" :label="$t('page.business.license.licenseId')" path="licenseId"
                     class="pr-24px">
          <NInput v-model:value="model.licenseId" :placeholder="$t('page.business.license.form.licenseId')"/>
        </NFormItemGi>

        <NFormItemGi span="24 s:8 m:6" :label="$t('page.business.license.companyName')" path="companyName"
                     class="pr-24px">
          <NInput v-model:value="model.companyName" :placeholder="$t('page.business.license.form.companyName')"/>
        </NFormItemGi>

        <NFormItemGi span="24 s:8 m:6" :label="$t('page.business.license.taxIdentificationNumber')"
